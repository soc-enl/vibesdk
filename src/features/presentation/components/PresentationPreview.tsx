...
export function PresentationPreview({
  ...
  const { timestamps, generatingSlides, setGeneratingSlides } =
    usePresentationSync(files, slideFiles, slideDirectory, currentSlideIndex);
